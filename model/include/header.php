  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarsExample07">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="model/appointments.php">Appointments of Patients'</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="model/doctors.php">Doctors' Information</a>
        </li> 
      </ul>
      <ul class="navbar-nav">
